...
const IMAGE_ENGINES = [
  {
    ...
    desc: "Google-এর অফিশিয়াল নেটিভ ইমেজ জেনারেশন মডেল। নিখুঁত বাংলা প্রম্পট অনুধাবন, বাস্তব আলো ও সর্বোচ্চ ডিটেইলড ছবি।",
    badge: "Gemini অফিশিয়াল",
    speed: "HD / 1K"
  },
  {
    id: "gemini-3.1-flash-lite-image",
    name: "⚡ Gemini 3.1 Flash Lite Image",
    desc: "উচ্চ গতির লাইটওয়েট জেমিনি ইমেজ জেনারেশন মডেল। দ্রুত ছবি প্রসেসিং ও অপটিমাইজড পারফরম্যান্স।",
    badge: "হাই-স্পিড জেমিনি",
    speed: "Fast"
  }
];
