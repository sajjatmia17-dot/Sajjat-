    ...
    <>
      ...
      >
        ...
        <div className="p-2.5 border-t border-slate-800 bg-slate-950/70 space-y-1">
          ...
          <button
            onClick={() => {
              onOpenModal("book_library");
              if (window.innerWidth < 1024) onClose();
            }}
            className="w-full flex items-center justify-between px-3 py-2 rounded-xl text-xs font-semibold text-amber-300 hover:text-amber-200 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 transition-all shadow-xs"
            title="বই পড়ুন বা ডাউনলোড করুন"
          >
            <div className="flex items-center gap-2.5">
              <span className="text-sm">📚</span>
              <span>বই পড়ুন (Book Library)</span>
            </div>
            <span className="text-[10px] px-1.5 py-0.5 rounded-md bg-amber-500/20 font-bold text-amber-400">
              NCTB
            </span>
          </button>
          ...
          <button
            onClick={() => {
              onOpenModal("html_viewer");
              if (window.innerWidth < 1024) onClose();
            }}
            className="w-full flex items-center justify-between px-3 py-2 rounded-xl text-xs font-semibold text-emerald-300 hover:text-emerald-200 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/30 transition-all shadow-xs"
            title="Sajjat AI এর পূর্ণাঙ্গ Standalone HTML ফাইল দেখুন বা ডাউনলোড করুন"
          >
            <div className="flex items-center gap-2.5">
              <FileCode className="w-4 h-4 text-emerald-400" />
              <span>HTML ফাইল (Sajjat_AI.html)</span>
            </div>
            <span className="text-[10px] px-1.5 py-0.5 rounded-md bg-emerald-500/20 font-bold text-emerald-400">
              DOWNLOAD
            </span>
          </button>
          ...
          {user ? (
            <div className="bg-slate-850 p-2.5 rounded-xl border border-slate-700/60 flex items-center justify-between">
              ...
              <button
                ...
                className="text-[11px] text-indigo-400 hover:text-indigo-300 font-medium px-2 py-1 rounded-lg hover:bg-slate-800"
              >
                প্রোফাইল
              </button>
            </div>
