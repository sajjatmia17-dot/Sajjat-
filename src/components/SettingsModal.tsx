    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/75 backdrop-blur-xs animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="py-4 space-y-6">
          ...
          {/* Section 3: Standalone HTML File */}
          <div className="pt-2 border-t border-slate-800 space-y-2.5">
            <label className="text-xs font-bold text-slate-200 flex items-center gap-2">
              <FileCode className="w-4 h-4 text-emerald-400" />
              <span>একক HTML ফাইল (Single-file Standalone)</span>
            </label>
            <div className="p-3.5 rounded-2xl bg-emerald-950/20 border border-emerald-500/20 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              <div className="text-xs text-slate-300">
                <strong className="text-white block font-semibold">Sajjat_AI.html (অফলাইন সংস্করণ)</strong>
                <span className="text-[11px] text-slate-400">
                  কোনো সার্ভার ছাড়া যেকোনো ব্রাউজারে ডাবল ক্লিক করলেই চলবে।
                </span>
              </div>
              <div className="flex items-center gap-2 shrink-0 w-full sm:w-auto">
                {onOpenHtmlViewer && (
                  <button
                    ...
                    className="flex-1 sm:flex-initial px-3 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold border border-slate-700 transition-colors flex items-center justify-center gap-1.5"
                  >
                ...
                <a
                  href="/download-html"
                  download="Sajjat_AI.html"
                  className="flex-1 sm:flex-initial px-3.5 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold shadow-md shadow-emerald-600/20 transition-all flex items-center justify-center gap-1.5"
                >
          ...
          <div className="p-3.5 rounded-2xl bg-slate-950/60 border border-slate-800 text-xs text-slate-400 space-y-1.5">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-emerald-400 font-mono text-[11px]">Sajjat AI Core Engine & Gemini</span>
            </div>
          </div>
        </div>
